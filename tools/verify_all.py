#!/usr/bin/env python3
# tools/verify_all.py
import sys, json, pathlib, hashlib, argparse, glob
...
def main():
    ...
    md5_w, sha_w = 6, 9  # widths for 'True'/'False' cells with headers 'MD5==' and 'SHA256!='
    ...
    for r in results:
        ...
        print(line)
        # If there was an error, show a dim hint (one extra line)
        if "_err" in r:
